...
class Content(tk.Frame):
    def __init__(self, master: tk.Tk):
        ...
        self.unit_content='''**Reparez ce programme permettant de definir le type d'un triangle selon les valeurs de ses cotes**
...
'''
        ...
        self.entry1 = tk.Entry(self.mainFrame)
        self.widget.window_create(3.28, window=self.entry1)
        self.entry2 = tk.Entry(self.mainFrame)
        self.widget.window_create(4.4, window=self.entry2)
        self.entry3 = tk.Entry(self.mainFrame)
        self.widget.window_create(6.4, window=self.entry3)
        self.entry4 = tk.Entry(self.mainFrame)
        self.widget.window_create(6.13, window=self.entry4)
        self.entry5 = tk.Entry(self.mainFrame)
        self.widget.window_create(6.24, window=self.entry5)
        self.entry6 = tk.Entry(self.mainFrame)
        self.widget.window_create(10.0, window=self.entry6)
    ...
    def check(self):
        if "and" in self.entry1.get() and "if" in self.entry2.get() and "elif" in self.entry3.get() and "or" in self.entry4.get() and "or" in self.entry5.get() and "else" in self.entry6.get():
