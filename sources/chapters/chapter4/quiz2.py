...
class Content(tk.Frame):
    def __init__(self, master: tk.Tk):
        ...
        self.unit_content='''**Trouvez si la note de l'eleve est inferieure, superieure ou egale a la moyenne de 10**
...
'''
        ...
        self.widget.window_create(5.0, window=self.entry1)
        self.entry2 = tk.Entry(self.mainFrame)
        self.widget.window_create(5.12, window=self.entry2)
        self.entry3 = tk.Entry(self.mainFrame)
        self.widget.window_create(7.0, window=self.entry3)
        self.entry4 = tk.Entry(self.mainFrame)
        self.widget.window_create(7.12, window=self.entry4)
    ...
    def check(self):
        if "elif" in self.entry1.get() and ">" in self.entry2.get() and "==" in self.entry3.get() and "elif" or 'else' in self.entry4.get() :
