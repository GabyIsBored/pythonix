...
class Content(tk.Frame):
    def __init__(self, master: tk.Tk):
        ...
        self.unit_content='''**Programmez une boucle qui divise un nombre par 2 et s'arrete quand celui devient plus petit que 10 **

nombre=100
while plusGrandQue10:
    nombre2
    if nombre<:
        plusGrandQue10 = 
'''
        ...
        self.widget.window_create(5.10, window=self.entry1)
        self.entry2 = tk.Entry(self.mainFrame)
        self.widget.window_create(6.14, window=self.entry2)
        self.entry3 = tk.Entry(self.mainFrame)
        self.widget.window_create(8.25, window=self.entry3)
