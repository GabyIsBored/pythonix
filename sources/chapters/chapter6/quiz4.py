...
class Content(tk.Frame):
    def __init__(self, master: tk.Tk):
        ...
        self.unit_content='''**Faite en sorte que si le nombre est egal a 3, la boucle passe directement a l'iteration prochaine **
...
'''
        ...
        self.widget.window_create(7.4, window=self.entry1)
