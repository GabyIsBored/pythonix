...
class Content(tk.Frame):
    def __init__(self, master: tk.Tk):
        ...
        self.unit_content='''**Affichez tout le contenu de la liste 3 fois d'affilee **

jeux=['basket','football','rugby']
for i in (  ):
    for element in :
        print()
'''
        ...
        self.widget.window_create(4.9, window=self.entry1)
        self.entry2 = tk.Entry(self.mainFrame)
        self.widget.window_create(4.11, window=self.entry2)
        self.entry3 = tk.Entry(self.mainFrame)
        self.widget.window_create(5.19, window=self.entry3)
        self.entry4 = tk.Entry(self.mainFrame)
        self.widget.window_create(6.14, window=self.entry4)
    ...
    def check(self):
        if "range" in self.entry1.get() and "2" in self.entry2.get() and "jeux" in self.entry3.get() and "element" in self.entry4.get():
