...
class Content(tk.Frame):
    def __init__(self, master: tk.Tk):
        ...
        self.unit_content='''**Affichez les multiples de 5 entre 7 et 14**
...
'''
    ...
    def check(self):
        if "i" in self.entry1.get() and "5" in self.entry2.get() and "14" in self.entry3.get() and "5" in self.entry4.get() :
