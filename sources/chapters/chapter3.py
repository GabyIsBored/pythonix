...
background=tk.PhotoImage(file='sources/assets/ChapterSelectionBackgrounds/Arithmetique et Comparaisons.png')
...
q1Img = canvas.create_image(242, 536, image=quiz, anchor="nw")
n2Img = canvas.create_image(428, 908, image=n2, anchor="nw")
q2Img = canvas.create_image(186, 1186, image=quiz, anchor="nw")
n3Img = canvas.create_image(423, 1503, image=n3, anchor="nw")
q3Img = canvas.create_image(69, 1793, image=quiz, anchor="nw")
n4Img = canvas.create_image(209, 2169, image=n4, anchor="nw")
q4Img = canvas.create_image(487, 2064, image=quiz, anchor="nw")
mImg = canvas.create_image(639, 2411, image=megaQuiz, anchor="nw")
