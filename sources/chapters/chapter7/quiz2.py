...
class Content(tk.Frame):
    def __init__(self, master: tk.Tk):
        ...
        self.unit_content='''*Retournez le deuxieme parametre de la fonction multiple par 7**
...
'''
        ...
        self.widget.window_create(4.5, window=self.entry2)
    ...
    def check(self):
        if "return" in self.entry1.get() and "b" in self.entry2.get():
