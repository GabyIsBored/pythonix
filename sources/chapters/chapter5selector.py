...
from chapters.chapter5 import unit1 
from chapters.chapter5 import quiz1 
from chapters.chapter5 import unit2 
from chapters.chapter5 import quiz2
from chapters.chapter5 import megaquiz
...
class ChapterFrame(tk.Frame):
    ...
    def __init__(self, master: tk.Tk):
        ...
        n1Img = self.canvas.create_image(574, 324, image=self.n1, anchor="nw")
        q1Img = self.canvas.create_image(104, 680, image=self.quiz, anchor="nw")
        n2Img = self.canvas.create_image(667, 536, image=self.n2, anchor="nw")
        q2Img = self.canvas.create_image(662, 855, image=self.quiz, anchor="nw")
        mImg = self.canvas.create_image(540, 1159, image=self.megaQuiz, anchor="nw")
    ...
    def loadAssets(self):
        self.background=tk.PhotoImage(file='sources/assets/ChapterSelectionBackgrounds/Listes et Dictionnaires.png')
